...
public class daoUsuario {
    ...
    String tabla="create table if not exists usuario(id integer primary key autoincrement,usuario text, pass text,pass2 text, nombre text, ap text,corr text)";
